      ...
      <body>
        <div class="template">
          ...
          <div class="template__inner-wrapper">
            <h3 class="template__title">Password Reset</h3>
            <p class="template__main-text">
              Hello ${name}. If you lost your password or just want to reset your current password, let's proceed to create a new one by clicking the link below
            </p>
            ...
            <div class="template__secondary-text">
              ...
              <br>
              <span>If you didn't request a password reset, you can just ignore this email.</span>
              <br>
